...
function redrawChart(data) {
    ...
    console.log("rightY Domain: " + d3.max(data, function(d) {
        return d.remaining;
    }));
    console.log("leftY Domain: " + d3.max(data, function(d) {
        return d.principal;
    }));
    leftY.domain([0, d3.max(data, function(d) {
        return d.principal;
    })]);
    rightY.domain([0, d3.max(data, function(d) {
        return d.remaining;
    })]);
